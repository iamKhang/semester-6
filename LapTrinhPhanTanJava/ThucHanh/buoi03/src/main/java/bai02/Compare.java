...
public class Compare {
	...
	public static void main(String[] args) {
		...
		System.out.println("Thoi gian khi su dung parallelStream(): " + executionTimeInSeconds);
		...
		System.out.println("Thoi gian khi khong su sung parallelStream(): " + executionTimeInSeconds);
	}
}
